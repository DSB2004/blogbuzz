  ...
  return (
    <>
      ...
      <main className="fixed top-0 min-h-svh flex items-center justify-center w-full">
        ...
        >
          <h1 className=" my-5 mb-8 text-3xl font-bold text-center uppercase">
            Forget Password
          </h1>
          <p className="text-md text-center">
            Enter your blogbuzz account email for password recovery
          </p>
          <Input_1
            className="mt-6"
          ...
          <Button_2 type="submit" className=" my-2 w-64">
            Sumbit Email
          </Button_2>
        </form>
      </main>
